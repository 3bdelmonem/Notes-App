...
class _LoginState extends State<Login>{
  ...
  Icon hiddenIcon = Icon(Icons.remove_red_eye_outlined, color: Color(0xFF6034A6), size: 22);
  Icon visibleIcon = Icon(Icons.remove_red_eye, color: Colors.white, size: 22);
  Icon passordIcon = Icon(Icons.remove_red_eye_outlined, color: Color(0xFF6034A6), size: 22);
